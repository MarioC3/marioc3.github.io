...
Webflow.require('ix').init([
  ...
  {"slug":"project-1","name":"Project 1","value":{"style":{},"triggers":[{"type":"hover","selector":".hoverblock","stepsA":[{"display":"block","opacity":0},{"opacity":1,"transition":"opacity 400ms ease-in-cubic 0"}],"stepsB":[{"opacity":0,"transition":"opacity 500ms ease-in-cubic 0"},{"display":"none","opacity":0}]},{"type":"hover","selector":".hovertext","preserve3d":true,"stepsA":[{"display":"block","opacity":0},{"opacity":1,"transition":"opacity 500ms ease-in-cubic 0, transform 500ms ease-in-cubic 0","scaleX":1.07,"scaleY":1.07,"scaleZ":1}],"stepsB":[{"opacity":0,"transition":"opacity 500ms ease-in-cubic 0"},{"display":"none","opacity":0}]}]}}
]);
