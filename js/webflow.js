...
Webflow.require('ix').init([
  ...
  {"slug":"projects","name":"projects","value":{"style":{"opacity":0},"triggers":[{"type":"load","stepsA":[{"opacity":1,"transition":"opacity 600ms ease-in-quad 0"}],"stepsB":[]}]}},
  {"slug":"project1","name":"Project1","value":{"style":{"opacity":0,"x":"0px","y":"-100px","z":"0px"},"triggers":[{"type":"scroll","offsetTop":"30%","offsetBot":"30%","stepsA":[{"opacity":1,"transition":"transform 500ms ease-in-cubic 0, opacity 500ms ease-in-cubic 0","x":"0px","y":"0px","z":"0px"}],"stepsB":[{"opacity":0,"transition":"transform 500ms ease-in-cubic 0, opacity 500ms ease-in-cubic 0"}]}]}},
  {"slug":"scrollout","name":"scrollout","value":{"style":{},"triggers":[{"type":"scroll","selector":".image-6","offsetBot":"0%","stepsA":[{"opacity":0,"transition":"opacity 308ms ease-in-cubic 0"}],"stepsB":[]}]}},
  {"slug":"scrollin","name":"scrollin","value":{"style":{},"triggers":[{"type":"scroll","selector":".image-6","stepsA":[],"stepsB":[{"opacity":1,"transition":"opacity 500ms ease-in-cubic 0"}]}]}}
]);
